...
from trainers import baseline_trainer, baseline_eval
...
config = {
    "Baseline": {"model":Baseline, "trainer":baseline_trainer},
    "GCN": GCN,
...
def main(model_name):
    ...
    model = config[model_name]["model"](dataset.num_features, hidden_dim=64)
    optimizer = torch.optim.Adam(model.parameters(), lr=0.01)
    trainer = config[model_name]["trainer"]
    train_losses, val_losses = trainer(model, 
                                       optimizer, 
                                       train_loader, 
                                       val_loader, 
                                       num_epochs, 
...
if __name__ == '__main__':
    ...
    model_name = "Baseline"
    train_losses, val_losses = main(model_name)
